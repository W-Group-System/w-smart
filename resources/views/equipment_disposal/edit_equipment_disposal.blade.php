<div class="modal fade" id="editDisposal{{ $disposal_asset->id }}" tabindex="-1" aria-labelledby="addDisposalModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="{{ url('store_disposal_asset') }}" method="POST" onsubmit="show()" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control" name="date_of_transfer" required>
                        </div>
                        <div class="col-md-6">
