                            ...
                            <tr>
                                <td>
                                    ...
                                    @if($company->status == 'Inactive')
                                        <form method="POST" action="{{url('activate_company/'.$company->subsidiary_id)}}" class="d-inline" id="activateForm{{$company->subsidiary_id}}" onsubmit="show()">
                                            @csrf
                                    ...
                                    @else
                                        <form method="POST" action="{{url('deactivate_company/'.$company->subsidiary_id)}}" class="d-inline" id="deactivateForm{{$company->subsidiary_id}}" onsubmit="show()">
                                            @csrf
