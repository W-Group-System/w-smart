            ...
            <div class="card shadow-sm"
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="text-center">
                        ...
                        <h3 class="card-text fw-bold mb-0">{{count($departments)}}</h3>
                    </div>
            ...
            <div class="card shadow-sm"
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="text-center">
                        ...
                        <h3 class="card-text fw-bold mb-0">{{count($departments->where('status','Active'))}}</h3>
                    </div>
            ...
            <div class="card shadow-sm"
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    <div class="text-center">
                        ...
                        <h3 class="card-text fw-bold mb-0">{{count($departments->where('status','Inactive'))}}</h3>
                    </div>
                    <a href="#" id="viewTable2" class="btn btn-primary btn-sm" style="min-width: 110px; border-radius: 7px;">View
                        All</a>
                </div>
